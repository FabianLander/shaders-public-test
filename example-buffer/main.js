...
`, ""), w = y;
      ...
      return {
        ...
        error: Et(_, b, E),
        codeContext: w !== null && m ? Tt(m, w) : null
      };
...
function wt(i, e) {
  const t = xt(i, e), n = new Blob([t], { type: "text/html" }), r = `${i.root.split("/").pop() || "shader"}.html`, o = URL.createObjectURL(n), a = document.createElement("a");
...
class M {
  ...
  exportHTML() {
    ...
    wt(this.project, this.primaryView.engine);
  }
  openRenderDialog() {
...
const ie = ["Image", "BufferA", "BufferB", "BufferC", "BufferD"], Ot = ["BufferA", "BufferB", "BufferC", "BufferD"], Pe = ["iChannel0", "iChannel1", "iChannel2", "iChannel3"], Ht = "default", De = !0, Vt = "light", Me = /* @__PURE__ */ new Set([
  "iResolution",
  "iTime",
  "iTimeDelta",
  "iFrame",
  ...
  "iPinchDelta",
  "iPinchCenter"
]), jt = /^[a-zA-Z_][a-zA-Z0-9_]*$/, Xt = /* @__PURE__ */ new Set([
  "attribute",
  "const",
  "uniform",
  "varying",
...
function $(i) {
  return jt.test(i) && !Xt.has(i);
}
const be = /* @__PURE__ */ new Set(["fullscreen", "default", "split", "tabbed"]), q = /* @__PURE__ */ new Set(["light", "dark", "system"]), Kt = /* @__PURE__ */ new Set([
  "mode",
  "title",
  "author",
  "description",
...
function zt(i, e) {
  ...
  for (const r of Object.keys(i))
    Kt.has(r) || t.push(`Unknown config key '${r}'`);
...
const xe = /* @__PURE__ */ new Set(["float", "int", "bool", "vec2", "vec3", "vec4"]), _e = /* @__PURE__ */ new Set(["float", "vec2", "vec3", "vec4", "mat3", "mat4"]), Wt = {
  vec2: 2,
  vec3: 3,
  vec4: 4
};
...
async function Jt(i, e, t) {
  ...
  return n ? (zt(n, e), n.mode === "shadertoy" ? en(i, e, n, t) : tn(i, e, n, t)) : Qt(i, e, t);
}
...
async function sn(i, e, t, n, s) {
  ...
  for (const [b, T] of Object.entries(t.textures ?? {}))
    ...
    } else nn.has(T) || l.set(b, { kind: "script", name: T });
...
async function rn(i, e, t, n, s) {
  ...
  const c = await Be(r, s), l = Ie(e, n), d = await Jt(l, r, {
    config: a,
    script: c,
...
const an = /* @__PURE__ */ Object.assign({ "./shaders/example-buffer/bufferA.glsl": () => Promise.resolve().then(() => En).then((i) => i.default), "./shaders/example-buffer/image.glsl": () => Promise.resolve().then(() => Tn).then((i) => i.default) }), cn = /* @__PURE__ */ Object.assign({ "./shaders/example-buffer/config.json": () => Promise.resolve().then(() => yn).then((i) => i.default) }), ln = /* @__PURE__ */ Object.assign({}), un = /* @__PURE__ */ Object.assign({});
let ne = null;
async function dn() {
  return ne || (ne = await rn("shaders/example-buffer", an, cn, ln, un)), ne;
}
        ...
        if (!(!p.hasOwnProperty(C) || !p[C])) {
          ...
          for (var R = 0; R < v.length; ++R) {
            ...
            if (ce && !F.pattern.global) {
              var ze = F.pattern.toString().match(/[imsuy]*$/)[0];
              F.pattern = RegExp(F.pattern.source, ze + "g");
            }
              ...
              if (!(I instanceof c)) {
                ...
                if (ce) {
                  if (P = l(le, D, m, B), !P || P.index >= m.length)
                    break;
                  var X = P.index, Ge = P.index + P[0].length, k = D;
                  for (k += L.value.length; X >= k; )
                    L = L.next, k += L.value.length;
                  if (k -= L.value.length, D = k, L.value instanceof c)
                    continue;
                  for (var N = L; N !== h.tail && (k < Ge || typeof N.value == "string"); N = N.next)
                    j++, k += N.value.length;
                  j--, I = m.slice(D, k), P.index -= D;
                } else if (P = l(le, 0, I, B), !P)
                  continue;
                var X = P.index, K = P[0], J = I.slice(0, X), ue = I.slice(X + K.length), Q = D + I.length;
                x && Q > x.reach && (x.reach = Q);
                var Y = L.prev;
                J && (Y = E(h, Y, J), D += J.length), y(h, Y, j);
                var We = new c(C, S ? a.tokenize(K, S) : K, Ye, K);
                if (L = E(h, Y, We), ue && E(h, L, ue), j > 1) {
                  var ee = {
                    cause: C + "," + R,
                    reach: Q
                  };
...
const Oe = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  createEditor: pn
}, Symbol.toStringTag, { value: "Module" })), gn = `void mainImage(out vec4 fragColor, in vec2 fragCoord)
{
...
`, En = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: gn
}, Symbol.toStringTag, { value: "Module" })), vn = `void mainImage(out vec4 fragColor, in vec2 fragCoord)
{
...
`, Tn = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: vn
}, Symbol.toStringTag, { value: "Module" })), He = "shadertoy", Ve = "default", je = !0, Xe = {
  iChannel0: "BufferA"
}, Ke = {
  iChannel0: "BufferA"
}, bn = {
