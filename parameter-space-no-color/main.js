...
class ut {
  ...
  updateAudioTexture(e) {
    var t;
    (t = this._audioTexture) != null && t.analyser && (this._audioTexture.analyser.getByteFrequencyData(this._audioTexture.frequencyData), this._audioTexture.analyser.getByteTimeDomainData(this._audioTexture.waveformData), Je(e, this._audioTexture.texture, this._audioTexture.frequencyData, this._audioTexture.waveformData));
  }
...
async function Wt(i, e, t) {
  ...
  return n ? (jt(n, e), n.mode === "shadertoy" ? Zt(i, e, n, t) : Qt(i, e, n, t)) : qt(i, e, t);
}
...
const Jt = /* @__PURE__ */ new Set(["keyboard", "audio", "webcam"]);
async function en(i, e, t, n, r) {
  ...
  for (const [T, b] of Object.entries(t.textures ?? {}))
    ...
    } else Jt.has(b) || l.set(T, { kind: "script", name: b });
...
const rn = /* @__PURE__ */ Object.assign({ "./shaders/parameter-space-no-color/image.glsl": () => Promise.resolve().then(() => pn).then((i) => i.default) }), sn = /* @__PURE__ */ Object.assign({ "./shaders/parameter-space-no-color/config.json": () => Promise.resolve().then(() => gn).then((i) => i.default) }), on = /* @__PURE__ */ Object.assign({}), an = /* @__PURE__ */ Object.assign({});
let ne = null;
async function cn() {
  return ne || (ne = await tn("shaders/parameter-space-no-color", rn, sn, on, an)), ne;
}
          ...
          for (var C = 0; C < E.length; ++C) {
            ...
            for (var le = F.pattern || F, k = p.next, P = g; k !== h.tail && !(w && P >= w.reach); P += k.value.length, k = k.next) {
              ...
              if (!(I instanceof c)) {
                ...
                var G = k.prev;
                Q && (G = v(h, G, Q), P += Q.length), y(h, G, V);
...
const $e = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  createEditor: hn
}, Symbol.toStringTag, { value: "Module" })), mn = `float EPS=1e-6;
float thick= 0.01;
int checks = 200;
...
`, pn = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: mn
}, Symbol.toStringTag, { value: "Module" })), ze = "default", He = !0, fn = {
  layout: ze,
  controls: He
