...
class Ae {
  ...
  createVec2Pad(e, t) {
    ...
    const b = (p) => {
      ...
      const F = r[0] + E * (s[0] - r[0]), S = r[1] + (1 - C) * (s[1] - r[1]), U = [F, S];
...
async function Dt(i, e) {
  ...
  return n || i.classList.add("unstyled"), oe(t.theme), Re(t) ? Bt(i, t, r) : Mt(i, t, r);
}
function Mt(i, e, t) {
  const n = Lt(e.layout, {
    container: i,
...
async function Zt(i, e, t, n) {
  ...
  const o = await Me(i, e, t.common), a = new Be(), c = /* @__PURE__ */ new Map();
  ...
  for (const u of ie) {
    ...
    if (!d)
      continue;
    const v = d.source ?? Ut(u), y = i.joinPath(e, v);
    if (!await i.exists(y))
...
async function tn(i, e, t, n, r) {
  ...
  const c = await Ue(s, r), l = Ie(e, n), d = await Wt(l, s, {
    config: a,
    script: c,
...
const rn = /* @__PURE__ */ Object.assign({ "./shaders/quad-dual/common.glsl": () => Promise.resolve().then(() => pn).then((i) => i.default), "./shaders/quad-dual/image.glsl": () => Promise.resolve().then(() => gn).then((i) => i.default) }), sn = /* @__PURE__ */ Object.assign({ "./shaders/quad-dual/config.json": () => Promise.resolve().then(() => En).then((i) => i.default) }), on = /* @__PURE__ */ Object.assign({}), an = /* @__PURE__ */ Object.assign({});
let ne = null;
async function cn() {
  return ne || (ne = await tn("shaders/quad-dual", rn, sn, on, an)), ne;
}
      ...
      for (var R in f)
        if (!(!f.hasOwnProperty(R) || !f[R])) {
          ...
          for (var C = 0; C < E.length; ++C) {
            if (w && w.cause == R + "," + C)
              return;
            var F = E[C], S = F.inside, U = !!F.lookbehind, ce = !!F.greedy, Ve = F.alias;
