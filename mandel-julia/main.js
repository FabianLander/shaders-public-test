  ...
  set(e, t) {
    ...
    if (this._store.set(e, t), A(n)) {
      ...
      if (s) {
        ...
        const c = r.length / a, l = ct(n.type, c, r, s.paddedData);
        l !== s.paddedData && s.paddedData.set(l);
        const u = at(n.type, c), d = s.paddedData.length;
...
class ge {
  constructor(e) {
    ...
    this._keyboardTexture = {
      ...
      width: 256,
      height: 3
    }, this.initProjectTextures(), this._media = new mt(this.gl, e.project), this._uniformMgr = new pt(this.gl, e.project.uniforms), e.viewNames && e.viewNames.length > 1 && (this._viewNames = e.viewNames), this.initRuntimePasses();
  }
  // ===========================================================================
  ...
  updateTexture(e, t, n, s) {
    ...
    if (r && r.width === t && r.height === n && r.isFloat === o) {
      ...
      const a = st(this.gl, (r == null ? void 0 : r.texture) ?? null, t, n, s);
  ...
  step(e, t, n, s, r) {
    ...
    for (const E of d) {
      const y = this._passes.find((T) => T.name === E);
   ...
   */
  initRuntimePasses() {
    const e = this.gl, t = this.project, n = Je(e);
    this._sharedVAO = n;
    ...
    for (const r of s) {
      ...
      try {
        const l = he(e, pe, a), u = this.cacheUniformLocations(l, o.namedSamplers), d = K(e, this._width, this._height), E = K(e, this._width, this._height), y = me(e, d), T = {
          name: r,
        ...
        if (d) {
          ...
          if (c.commonStartLine > 0 && c.commonLines > 0) {
            ...
            T >= c.commonStartLine && T <= b && (E = !0, y = T - c.commonStartLine + 1);
          }
          !E && c.userCodeStartLine > 0 && T >= c.userCodeStartLine && (y = T - c.userCodeStartLine + 1);
        }
...
class gt {
  ...
  show(e, t) {
    ...
    const n = e.filter((u) => u.isFromCommon), s = e.filter((u) => !u.isFromCommon), c = [...n.length > 0 ? [n[0]] : [], ...s].map(({ passName: u, error: d, isFromCommon: E, originalLine: y, lineMapping: T }) => {
...
`) : "";
    ...
    `, this.wireClose(), this.autoHideTimer = setTimeout(() => this.hide(), V.AUTO_HIDE_MS);
  }
  /**
...
const j = {};
for (let i = 0; i < 26; i++)
  j[`Key${String.fromCharCode(65 + i)}`] = 65 + i;
for (let i = 0; i < 10; i++)
  j[`Digit${i}`] = 48 + i;
for (let i = 1; i <= 12; i++)
  j[`F${i}`] = 111 + i;
...
class Ae {
  ...
  createVec2Pad(e, t) {
    ...
    const y = (f) => {
      const g = (f[0] - s[0]) / (r[0] - s[0]) * 100, w = (1 - (f[1] - s[1]) / (r[1] - s[1])) * 100;
      E.style.left = `${g}%`, E.style.top = `${w}%`;
    };
    y(n);
    let T = !1;
    const b = (f) => {
      const g = d.getBoundingClientRect(), w = "touches" in f ? f.touches[0].clientX : f.clientX, C = "touches" in f ? f.touches[0].clientY : f.clientY;
      let v = Math.max(0, Math.min(1, (w - g.left) / g.width)), R = Math.max(0, Math.min(1, (C - g.top) / g.height));
  ...
  createColorPicker4(e, t) {
    ...
    const E = ((b = t.step) == null ? void 0 : b[3]) ?? 0.01, { element: y, update: T } = this.createSliderRow({
      label: "Alpha",
  ...
  createVecSliders(e, t, n) {
    ...
    return o.forEach((u, d) => {
      var _, m, h;
      const E = ((_ = t.step) == null ? void 0 : _[d]) ?? 0.01, { element: y, update: T } = this.createSliderRow({
        label: u,
...
function xt(i, e) {
  const t = wt(i, e), n = new Blob([t], { type: "text/html" }), r = `${i.root.split("/").pop() || "shader"}.html`, o = URL.createObjectURL(n), a = document.createElement("a");
...
`), T = r.map((v) => `// Array uniform: ${v.name} (max ${v.count})
...
`);
  let x = "", _ = "";
  u && ((w = i.script) != null && w.setup && (x = i.script.setup.toString()), (C = i.script) != null && C.onFrame && (_ = i.script.onFrame.toString()));
  const m = c ? `
// --- Keyboard helpers ---
const int KEY_A = 65; const int KEY_B = 66; const int KEY_C = 67; const int KEY_D = 68;
const int KEY_E = 69; const int KEY_F = 70; const int KEY_G = 71; const int KEY_H = 72;
...
class St {
  constructor(e, t, n, s) {
    this.parentContainer = e, this.canvasWidth = t, this.canvasHeight = n, this.onStartRender = s, this.cancelRenderFn = null, this.backdrop = document.createElement("div"), this.backdrop.className = "render-dialog-backdrop", this.backdrop.addEventListener("click", (w) => {
    ...
    m.htmlFor = "render-fmt-video", m.textContent = "Video (WebM)", _.appendChild(this.formatVideo), _.appendChild(m), T.appendChild(_), T.appendChild(b), y.appendChild(T), this.estimateEl = document.createElement("div"), this.estimateEl.className = "render-estimate", this.bodyEl.appendChild(c), this.bodyEl.appendChild(d), this.bodyEl.appendChild(E), this.bodyEl.appendChild(y), this.bodyEl.appendChild(this.estimateEl), this.actionsEl = document.createElement("div"), this.actionsEl.className = "render-dialog-actions";
...
class k {
  constructor(e) {
    ...
    if (this.recorder = new _t(this.primaryView.canvas, this.container, this.project.root), this.statsPanel = new Rt(this.container), this.statsPanel.updateResolution(this.primaryView.canvas.width, this.primaryView.canvas.height), this.isMultiView) {
    ...
    !e.skipUniformsPanel && this.project.uniforms && Object.values(this.project.uniforms).some((s) => se(s)) && (this.uniformsPanel = new yt({
  ...
  async renderVideoFrames(e, t, n, s) {
    ...
    for (let b = 0; b < e; b++) {
      ...
      x != null && x.requestFrame && x.requestFrame(), s(b + 1, e), b % 10 === 0 && await new Promise((_) => setTimeout(_, 0));
    }
    l.stop(), await d;
    const E = new Blob(u, { type: "video/webm" }), y = URL.createObjectURL(E), T = document.createElement("a");
    T.href = y, T.download = `render_${r.width}x${r.height}_${t}fps.webm`, T.click(), URL.revokeObjectURL(y);
  }
  stepForRender(e, t) {
    var r;
    const n = e / t, s = 1 / t;
  ...
  createPanel(e) {
    ...
    `, a.addEventListener("click", () => {
      ...
      u.className = "uniforms-container", this.controls = new Ae({
        ...
        onChange: (d, E) => {
          var y, T;
          (T = (y = this.opts).onSetUniformValue) == null || T.call(y, d, E);
        }
...
async function Bt(i, e) {
  ...
  return n || i.classList.add("unstyled"), oe(t.theme), Ce(t) ? Nt(i, t, s) : It(i, t, s);
}
function It(i, e, t) {
  const n = Dt(e.layout, {
    container: i,
...
function Nt(i, e, t) {
  const n = e.views.map((a) => a.name), s = Ut(e.viewLayout, {
    container: i,
    project: e,
    viewNames: n
  }), r = new k({
...
const ie = ["Image", "BufferA", "BufferB", "BufferC", "BufferD"], Ot = ["BufferA", "BufferB", "BufferC", "BufferD"], Me = ["iChannel0", "iChannel1", "iChannel2", "iChannel3"], Vt = "default", Pe = !0, jt = "light", ke = /* @__PURE__ */ new Set([
  "iResolution",
  "iTime",
  "iTimeDelta",
  "iFrame",
  ...
  "iPinchDelta",
  "iPinchCenter"
]), Ht = /^[a-zA-Z_][a-zA-Z0-9_]*$/, zt = /* @__PURE__ */ new Set([
  "attribute",
  "const",
  "uniform",
  "varying",
...
function $(i) {
  return Ht.test(i) && !zt.has(i);
}
const Te = /* @__PURE__ */ new Set(["fullscreen", "default", "split", "tabbed"]), q = /* @__PURE__ */ new Set(["light", "dark", "system"]), Xt = /* @__PURE__ */ new Set([
  "mode",
  "title",
  "author",
  "description",
  ...
  "views"
  // multi-view projects
]), Yt = /* @__PURE__ */ new Set(["source", "iChannel0", "iChannel1", "iChannel2", "iChannel3"]), ye = /* @__PURE__ */ new Set(["keyboard", "audio", "webcam"]);
function Kt(i, e) {
  const t = [], n = [];
  for (const r of Object.keys(i))
    Xt.has(r) || t.push(`Unknown config key '${r}'`);
  ...
  for (const r of ie) {
    ...
    if (!(!o || typeof o != "object")) {
      for (const a of Object.keys(o))
        Yt.has(a) || t.push(`Unknown key '${a}' in pass '${r}'`);
      for (const a of Me) {
        const c = o[a];
...
async function Zt(i, e, t) {
  ...
  return n ? (Kt(n, e), n.mode === "shadertoy" ? en(i, e, n, t) : tn(i, e, n, t)) : Qt(i, e, t);
}
...
async function en(i, e, t, n) {
  ...
  const o = await De(i, e, t.common), a = new Ue(), c = /* @__PURE__ */ new Map();
  ...
  for (const u of ie) {
    ...
    if (!d)
      continue;
    const E = d.source ?? $t(u), y = i.joinPath(e, E);
    if (!await i.exists(y))
...
async function tn(i, e, t, n) {
  ...
  const s = await De(i, e, t.common), r = t.buffers ?? {};
...
async function sn(i, e, t, n, s) {
  ...
  for (const [T, b] of Object.entries(t.textures ?? {}))
    if (b === "keyboard")
      ...
      let x;
      s != null && s.textureUrlResolver ? x = await s.textureUrlResolver(b) : x = b;
      const _ = c.register(x);
      l.set(T, { kind: "texture", name: _, cubemap: !1 });
    } else nn.has(b) || l.set(T, { kind: "script", name: b });
...
async function on(i, e, t, n, s) {
  ...
  for (const d of e.views) {
    ...
    let T;
    if (U(t, E))
      T = await r.readText(E);
    else if (U(t, y))
      T = await r.readText(y);
    else
...
const an = /* @__PURE__ */ Object.assign({ "./shaders/mandel-julia/julia.glsl": () => Promise.resolve().then(() => En).then((i) => i.default), "./shaders/mandel-julia/mandelbrot.glsl": () => Promise.resolve().then(() => bn).then((i) => i.default) }), cn = /* @__PURE__ */ Object.assign({ "./shaders/mandel-julia/config.json": () => Promise.resolve().then(() => yn).then((i) => i.default) }), ln = /* @__PURE__ */ Object.assign({}), un = /* @__PURE__ */ Object.assign({ "./shaders/mandel-julia/script.js": () => Promise.resolve().then(() => wn) });
let ne = null;
async function dn() {
  return ne || (ne = await rn("shaders/mandel-julia", an, cn, ln, un)), ne;
}
async function _n(i, e = {}) {
  const t = await dn();
  ...
  var t = function(n) {
    var s = /(?:^|\s)lang(?:uage)?-([\w-]+)(?=\s|$)/i, r = 0, o = {}, a = {
        ...
        DFS: function m(h, p, f, g) {
          ...
          for (var C in h)
            if (h.hasOwnProperty(C)) {
              ...
              R === "Object" && !g[w(v)] ? (g[w(v)] = !0, m(v, p, null, g)) : R === "Array" && !g[w(v)] && (g[w(v)] = !0, m(v, p, C, g));
            }
        }
      },
      plugins: {},
      ...
      highlightElement: function(m, h, p) {
        ...
        if (a.hooks.run("before-sanity-check", v), w = v.element.parentElement, w && w.nodeName.toLowerCase() === "pre" && !w.hasAttribute("tabindex") && w.setAttribute("tabindex", "0"), !v.code) {
      ...
      tokenize: function(m, h) {
        ...
        var g = new d();
        return E(g, g.head, m), u(m, g, h, g.head, 0), T(g);
      },
      /**
       * @namespace
       * @memberof Prism
      ...
      for (var C in p)
        if (!(!p.hasOwnProperty(C) || !p[C])) {
          ...
          for (var R = 0; R < v.length; ++R) {
            if (w && w.cause == C + "," + R)
              return;
            var F = v[R], S = F.inside, B = !!F.lookbehind, ce = !!F.greedy, Ye = F.alias;
            if (ce && !F.pattern.global) {
              var Ke = F.pattern.toString().match(/[imsuy]*$/)[0];
              F.pattern = RegExp(F.pattern.source, Ke + "g");
            }
            for (var le = F.pattern || F, L = f.next, P = g; L !== h.tail && !(w && P >= w.reach); P += L.value.length, L = L.next) {
              var I = L.value;
              ...
              if (!(I instanceof c)) {
                var H = 1, M;
                if (ce) {
                  if (M = l(le, P, m, B), !M || M.index >= m.length)
                    break;
                  var z = M.index, Ge = M.index + M[0].length, D = P;
                  for (D += L.value.length; z >= D; )
                    L = L.next, D += L.value.length;
                  if (D -= L.value.length, P = D, L.value instanceof c)
                    continue;
                  for (var N = L; N !== h.tail && (D < Ge || typeof N.value == "string"); N = N.next)
                    H++, D += N.value.length;
                  H--, I = m.slice(P, D), M.index -= P;
                } else if (M = l(le, 0, I, B), !M)
                  continue;
                var z = M.index, X = M[0], Z = I.slice(0, z), ue = I.slice(z + X.length), Q = P + I.length;
                w && Q > w.reach && (w.reach = Q);
                var Y = L.prev;
                Z && (Y = E(h, Y, Z), P += Z.length), y(h, Y, H);
                var We = new c(C, S ? a.tokenize(X, S) : X, Ye, X);
                if (L = E(h, Y, We), ue && E(h, L, ue), H > 1) {
                  var ee = {
                    cause: C + "," + R,
                    reach: Q
                  };
                  u(m, h, p, L.prev, P, ee), w && ee.reach > w.reach && (w.reach = ee.reach);
                }
              }
            }
          }
  ...
  i.exports && (i.exports = t), typeof Re < "u" && (Re.Prism = t), t.languages.markup = {
    ...
    function E(b, x, _) {
      ...
      m.open("GET", b, !0), m.onreadystatechange = function() {
        m.readyState == 4 && (m.status < 400 && m.responseText ? x(m.responseText) : m.status >= 400 ? _(s(m.status, m.statusText)) : _(r));
      }, m.send(null);
    }
    function y(b) {
      ...
      if (x.matches(d)) {
        ...
        f && f.loadLanguages(h), E(
          ...
          function(g) {
            ...
            if (w) {
              var C = g.split(/\r\n?|\n/g), v = w[0], R = w[1] == null ? C.length : w[1];
...
`, fn.highlightElement(c);
    const y = E.split(`
`);
    s.innerHTML = y.map((T, b) => `<span>${b + 1}</span>`).join(""), t && t(E);
  }
  function u() {
...
const Oe = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  createEditor: pn
}, Symbol.toStringTag, { value: "Module" })), gn = `// Julia Set Viewer
...
`, En = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: gn
}, Symbol.toStringTag, { value: "Module" })), vn = `// Mandelbrot Set Viewer
...
`, bn = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: vn
}, Symbol.toStringTag, { value: "Module" })), Ve = "Mandelbrot & Julia Sets", je = "Interactive exploration of the relationship between Mandelbrot and Julia sets. Click in the Mandelbrot view to set the Julia parameter.", He = [
  "mandelbrot",
  "julia"
], ze = "split", Xe = {
  uMaxIter: {
...
function xn(i, e, t, n) {
  const s = i.getCrossViewState("mandelbrot");
  if (!s) return;
  const [r, o] = s.mouse, [a, c] = s.resolution;
  if (r === 0 && o === 0) {
    i.setOverlay("top-left", `z → z² + c
c = -0.70 + 0.27i [default]`, "julia");
    return;
  }
  const l = r / a, u = o / c, d = -2.5 + l * 3.5, E = -1.5 + u * 3, y = E >= 0 ? "+" : "-", T = `${d.toFixed(2)} ${y} ${Math.abs(E).toFixed(2)}i`;
  i.setOverlay("top-left", `z → z² + c
c = ${T}`, "julia");
}
