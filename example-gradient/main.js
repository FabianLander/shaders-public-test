...
async function Mt(i, e) {
  ...
  return n || i.classList.add("unstyled"), oe(t.theme), Ce(t) ? Ut(i, t, s) : kt(i, t, s);
}
function kt(i, e, t) {
  const n = Pt(e.layout, {
    container: i,
...
const ie = ["Image", "BufferA", "BufferB", "BufferC", "BufferD"], Nt = ["BufferA", "BufferB", "BufferC", "BufferD"], Pe = ["iChannel0", "iChannel1", "iChannel2", "iChannel3"], It = "default", De = !0, $t = "light", Me = /* @__PURE__ */ new Set([
  "iResolution",
  "iTime",
  "iTimeDelta",
  "iFrame",
...
const sn = /* @__PURE__ */ Object.assign({ "./shaders/example-gradient/image.glsl": () => Promise.resolve().then(() => pn).then((i) => i.default) }), rn = /* @__PURE__ */ Object.assign({ "./shaders/example-gradient/config.json": () => Promise.resolve().then(() => gn).then((i) => i.default) }), on = /* @__PURE__ */ Object.assign({}), an = /* @__PURE__ */ Object.assign({});
let ne = null;
async function cn() {
  return ne || (ne = await tn("shaders/example-gradient", sn, rn, on, an)), ne;
}
              ...
              if (!(N instanceof c)) {
                ...
                if (ce) {
                  if (P = l(le, D, m, B), !P || P.index >= m.length)
                    break;
                  var X = P.index, Ke = P.index + P[0].length, k = D;
                  for (k += L.value.length; X >= k; )
                    L = L.next, k += L.value.length;
                  if (k -= L.value.length, D = k, L.value instanceof c)
                    continue;
                  for (var I = L; I !== h.tail && (k < Ke || typeof I.value == "string"); I = I.next)
                    j++, k += I.value.length;
                  j--, N = m.slice(D, k), P.index -= D;
...
const Oe = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  createEditor: hn
}, Symbol.toStringTag, { value: "Module" })), mn = `void mainImage(out vec4 fragColor, in vec2 fragCoord)
{
...
`, pn = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: mn
}, Symbol.toStringTag, { value: "Module" })), He = "default", Ve = !0, fn = {
  layout: He,
  controls: Ve
