...
const we = /* @__PURE__ */ new Set(["float", "int", "bool", "vec2", "vec3", "vec4"]), _e = /* @__PURE__ */ new Set(["float", "vec2", "vec3", "vec4", "mat3", "mat4"]), Kt = {
  vec2: 2,
  vec3: 3,
  vec4: 4
};
...
const sn = /* @__PURE__ */ Object.assign({ "./shaders/parameter-space-split/common.glsl": () => Promise.resolve().then(() => fn).then((i) => i.default), "./shaders/parameter-space-split/invertedStrip.glsl": () => Promise.resolve().then(() => vn).then((i) => i.default), "./shaders/parameter-space-split/resulting_pack.glsl": () => Promise.resolve().then(() => bn).then((i) => i.default), "./shaders/parameter-space-split/stripPack.glsl": () => Promise.resolve().then(() => yn).then((i) => i.default) }), on = /* @__PURE__ */ Object.assign({ "./shaders/parameter-space-split/config.json": () => Promise.resolve().then(() => wn).then((i) => i.default) }), an = /* @__PURE__ */ Object.assign({}), cn = /* @__PURE__ */ Object.assign({ "./shaders/parameter-space-split/script.js": () => Promise.resolve().then(() => _n) });
let ne = null;
async function ln() {
  return ne || (ne = await nn("shaders/parameter-space-split", sn, on, an, cn)), ne;
}
          ...
          for (var C = 0; C < E.length; ++C) {
            ...
            for (var le = F.pattern || F, k = p.next, P = g; k !== h.tail && !(w && P >= w.reach); P += k.value.length, k = k.next) {
              ...
              if (!(I instanceof c)) {
                ...
                var Ke = new c(R, S ? a.tokenize(X, S) : X, je, X);
                if (k = v(h, G, Ke), ue && v(h, k, ue), H > 1) {
                  var ee = {
                    cause: R + "," + C,
                    reach: J
                  };
