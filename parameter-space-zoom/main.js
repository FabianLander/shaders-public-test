...
function me(i, e) {
  ...
  if (n !== i.FRAMEBUFFER_COMPLETE)
    throw i.deleteFramebuffer(t), new Error(`Framebuffer incomplete: ${st(i, n)}`);
...
`, ut = `// --- Keyboard helpers (auto-injected) ---
// Letter keys
...
`), t.viewNames && t.viewNames.length > 1) {
    ...
    n.push(""), t.namedSamplers.has("keyboard") && (n.push(ut), n.push(""));
...
`), t.viewNames && t.viewNames.length > 1) {
  ...
  const r = Object.entries(t.uniforms).filter(([, d]) => !k(d));
  if (r.length > 0) {
...
class mt {
  ...
  updateAudioTexture(e) {
    var t;
    (t = this._audioTexture) != null && t.analyser && (this._audioTexture.analyser.getByteFrequencyData(this._audioTexture.frequencyData), this._audioTexture.analyser.getByteTimeDomainData(this._audioTexture.waveformData), nt(e, this._audioTexture.texture, this._audioTexture.frequencyData, this._audioTexture.waveformData));
  }
  updateVideoTextures(e) {
    for (const t of this._videoTextures)
      !t.ready || !t.video || t.video.readyState < HTMLMediaElement.HAVE_CURRENT_DATA || (it(e, t.texture, t.video), t.video.videoWidth > 0 && (t.width = t.video.videoWidth, t.height = t.video.videoHeight));
  }
  // ===========================================================================
  // Cleanup
  // ===========================================================================
...
class pt {
  ...
  initializeDefaults() {
    for (const [e, t] of Object.entries(this.definitions))
      k(t) ? this.values[e] = new Float32Array($(t.type, t.count)) : this.values[e] = this.cloneValue(t.value);
  }
  /**
  ...
  reset(e) {
    ...
    return t ? (k(t) ? this.values[e] = new Float32Array($(t.type, t.count)) : this.values[e] = this.cloneValue(t.value), !0) : !1;
  }
  /**
  ...
  getDefault(e) {
    const t = this.definitions[e];
    if (t)
      return k(t) ? new Float32Array($(t.type, t.count)) : this.cloneValue(t.value);
  }
  /**
...
class ft {
  constructor(e, t) {
    this._ubos = [], this._dirtyScalars = /* @__PURE__ */ new Set(), this._uniforms = t, this._store = new pt(t), this.initUBOs(e);
    for (const [n, r] of Object.entries(t))
      k(r) || this._dirtyScalars.add(n);
  }
  // ===========================================================================
  // Accessors
  // ===========================================================================
  ...
  set(e, t) {
    ...
    if (this._store.set(e, t), k(n)) {
      ...
      if (r) {
        ...
        const c = s.length / a, l = ct(n.type, c, s, r.paddedData);
        l !== r.paddedData && r.paddedData.set(l);
        const u = at(n.type, c), d = r.paddedData.length;
...
class ge {
  ...
  updateTexture(e, t, n, r) {
    ...
    if (s && s.width === t && s.height === n && s.isFloat === o) {
      ...
      const a = rt(this.gl, (s == null ? void 0 : s.texture) ?? null, t, n, r);
  ...
  step(e, t, n, r, s) {
    ...
    for (const v of d) {
      const T = this._passes.find((b) => b.name === v);
  ...
  updateKeyboardTexture() {
    this._keyboardTexture && et(this.gl, this._keyboardTexture.texture, this._keyStates, this._toggleStates);
  }
  /**
  ...
  cacheUniformLocations(e, t) {
    ...
    for (const [s, o] of Object.entries(this.project.uniforms))
      k(o) || r.set(s, n.getUniformLocation(e, s));
  ...
  initRuntimePasses() {
    ...
    for (const s of r) {
      ...
      try {
        const l = he(e, fe, a), u = this.cacheUniformLocations(l, o.namedSamplers), d = G(e, this._width, this._height), v = G(e, this._width, this._height), T = me(e, d), b = {
          name: s,
        ...
        if (d) {
          ...
          if (c.commonStartLine > 0 && c.commonLines > 0) {
            const y = c.commonStartLine + c.commonLines - 1;
            b >= c.commonStartLine && b <= y && (v = !0, T = b - c.commonStartLine + 1);
          }
          !v && c.userCodeStartLine > 0 && b >= c.userCodeStartLine && (T = b - c.userCodeStartLine + 1);
        }
...
class gt {
  ...
  show(e, t) {
    ...
    const n = e.filter((u) => u.isFromCommon), r = e.filter((u) => !u.isFromCommon), c = [...n.length > 0 ? [n[0]] : [], ...r].map(({ passName: u, error: d, isFromCommon: v, originalLine: T, lineMapping: b }) => {
      const y = d.replace(`Shader compilation failed:
`, ""), x = T;
      let _ = y;
      x !== null && (_ = y.replace(/ERROR:\s*\d+:(\d+):/g, `ERROR: 0:${x}:`));
      let m = null;
      if (v)
        m = t.commonSource;
      else {
...
`).map((n) => {
    ...
    if (r) {
      ...
      let c = a;
      return t && e.commonStartLine > 0 ? c = a - e.commonStartLine + 1 : e.userCodeStartLine > 0 && a >= e.userCodeStartLine && (c = a - e.userCodeStartLine + 1), `Line ${c}: ${Et(o)}`;
    }
    return n;
  }).join(`
`);
...
`);
  ...
  return t.slice(r, s).map((a, c) => {
    const l = r + c + 1, u = l === e, d = String(l).padStart(4, " "), v = ke(a);
...
class Ee {
  ...
  constructor(e) {
    ...
    }), this._resizeObserver.observe(this.container), this.input = new yt(this.canvas, this._pixelRatio), this.input.onFirstGesture = () => this.initMediaOnGesture(), this.initVideoFiles();
  }
  // ===========================================================================
  // Per-Frame Rendering
  // ===========================================================================
...
class Fe {
  constructor(e) {
    ...
    for (const [n, r] of Object.entries(this.uniforms))
      k(r) || r.hidden || (this.values[n] = ((t = e.initialValues) == null ? void 0 : t[n]) ?? r.value);
    this.render();
  }
  /**
  ...
  createVec2Pad(e, t) {
    ...
    const T = (p) => {
      const g = (p[0] - r[0]) / (s[0] - r[0]) * 100, w = (1 - (p[1] - r[1]) / (s[1] - r[1])) * 100;
      v.style.left = `${g}%`, v.style.top = `${w}%`;
    };
    T(n);
    let b = !1;
    const y = (p) => {
      const g = d.getBoundingClientRect(), w = "touches" in p ? p.touches[0].clientX : p.clientX, R = "touches" in p ? p.touches[0].clientY : p.clientY;
      let E = Math.max(0, Math.min(1, (w - g.left) / g.width)), C = Math.max(0, Math.min(1, (R - g.top) / g.height));
      const A = r[0] + E * (s[0] - r[0]), S = r[1] + (1 - C) * (s[1] - r[1]), B = [A, S];
      this.values[e] = B, v.style.left = `${E * 100}%`, v.style.top = `${C * 100}%`, u.textContent = this.formatVec2(B), this.onChange(e, B);
    }, x = (p) => {
      b = !0, y(p), p.preventDefault();
    }, _ = (p) => {
      b && y(p);
    }, m = () => {
      b = !1;
  ...
  createColorPicker4(e, t) {
    ...
    const v = ((y = t.step) == null ? void 0 : y[3]) ?? 0.01, { element: T, update: b } = this.createSliderRow({
      label: "Alpha",
  ...
  createVecSliders(e, t, n) {
    ...
    return o.forEach((u, d) => {
      var _, m, h;
      const v = ((_ = t.step) == null ? void 0 : _[d]) ?? 0.01, { element: T, update: b } = this.createSliderRow({
        label: u,
      ...
      }), y = T.querySelector(".uniform-control-label-row");
      if (y) {
        y.classList.add("uniform-control-vec-slider-row");
        const f = y.querySelector(".uniform-control-label");
        f && f.classList.add("uniform-control-vec-component");
        const p = y.querySelector(".uniform-control-value");
        p && p.classList.add("uniform-control-vec-value");
      }
      const x = T.querySelector(".uniform-control-slider");
      x && x.classList.add("uniform-control-vec-slider"), l.push(b), a.appendChild(T);
    }), {
      element: a,
      update: (u) => {
        const d = u;
  ...
  resetToDefaults() {
    for (const [e, t] of Object.entries(this.uniforms))
      k(t) || t.hidden || (this.setValue(e, t.value), this.onChange(e, t.value));
  }
  /**
...
function xt(i, e) {
  const t = wt(i, e), n = new Blob([t], { type: "text/html" }), s = `${i.root.split("/").pop() || "shader"}.html`, o = URL.createObjectURL(n), a = document.createElement("a");
...
function wt(i, e) {
  ...
  for (const E of o) {
    ...
    if (!C)
      continue;
    const A = C.channels.map((S) => S.kind === "buffer" ? `buffer:${S.buffer}` : S.kind === "texture" ? "procedural" : S.kind === "keyboard" ? (c = !0, "keyboard") : S.kind === "script" ? (l = !0, `script:${S.name}`) : S.kind === "audio" || S.kind === "webcam" || S.kind === "video" ? "black" : "none");
    a.push({
      name: E,
      source: C.glslSource,
      channels: C.channels,
  ...
  const u = !!((p = i.script) != null && p.setup || (g = i.script) != null && g.onFrame), d = Object.entries(i.uniforms).filter(([, E]) => !k(E)), v = [];
  for (const [E, C] of d) {
    if (k(C))
      continue;
    const A = r[E] ?? C.value;
...
`), b = s.map((E) => `// Array uniform: ${E.name} (max ${E.count})
...
`), y = s.map((E) => {
    const C = Array.from(E.paddedData).map((A) => A.toFixed(6)).join(", ");
...
class St {
  constructor(e, t, n, r) {
    ...
    const T = this.createField("Format"), b = document.createElement("div");
    ...
    y.className = "render-format-option";
    const x = document.createElement("label");
    x.htmlFor = "render-fmt-frames", x.textContent = "PNG Frames", y.appendChild(this.formatFrames), y.appendChild(x);
    const _ = document.createElement("div");
    _.className = "render-format-option";
    const m = document.createElement("label");
    m.htmlFor = "render-fmt-video", m.textContent = "Video (WebM)", _.appendChild(this.formatVideo), _.appendChild(m), b.appendChild(_), b.appendChild(y), T.appendChild(b), this.estimateEl = document.createElement("div"), this.estimateEl.className = "render-estimate", this.bodyEl.appendChild(c), this.bodyEl.appendChild(d), this.bodyEl.appendChild(v), this.bodyEl.appendChild(T), this.bodyEl.appendChild(this.estimateEl), this.actionsEl = document.createElement("div"), this.actionsEl.className = "render-dialog-actions";
...
class D {
  constructor(e) {
    ...
    if (this.recorder = new _t(this.primaryView.canvas, this.container, this.project.root), this.statsPanel = new Ct(this.container), this.statsPanel.updateResolution(this.primaryView.canvas.width, this.primaryView.canvas.height), this.isMultiView) {
    ...
    if (this.project.controls && !e.skipPlaybackControls && (this.playbackControls = new Rt(this.container, {
    ...
    !e.skipUniformsPanel && this.project.uniforms && Object.values(this.project.uniforms).some((r) => re(r)) && (this.uniformsPanel = new Tt({
  ...
  openRenderDialog() {
    new St(this.container, this.primaryView.canvas.width, this.primaryView.canvas.height, (t) => this.renderOffline(t)).open();
  }
  renderOffline(e) {
    let t = !1;
    const n = () => {
  ...
  async renderVideoFrames(e, t, n, r) {
    ...
    for (let y = 0; y < e; y++) {
      ...
      this.stepForRender(y, t), this.primaryView.presentToScreen(), a.drawImage(s, 0, 0);
      const x = c.getVideoTracks()[0];
      x != null && x.requestFrame && x.requestFrame(), r(y + 1, e), y % 10 === 0 && await new Promise((_) => setTimeout(_, 0));
    }
    l.stop(), await d;
    const v = new Blob(u, { type: "video/webm" }), T = URL.createObjectURL(v), b = document.createElement("a");
    b.href = T, b.download = `render_${s.width}x${s.height}_${t}fps.webm`, b.click(), URL.revokeObjectURL(T);
  }
  stepForRender(e, t) {
    var s;
    const n = e / t, r = 1 / t;
...
class At {
  ...
  createPanel(e) {
    ...
    `, a.addEventListener("click", () => {
      ...
      u.className = "uniforms-container", this.controls = new Fe({
        container: u,
        uniforms: e,
        onChange: (d, v) => {
          var T, b;
          (b = (T = this.opts).onSetUniformValue) == null || b.call(T, d, v);
        }
...
class Lt {
  ...
  async buildEditorPanel() {
    try {
      const { EditorPanel: e } = await Promise.resolve().then(() => mn);
      if (this._disposed)
        return;
...
async function Bt(i, e) {
  ...
  return n || i.classList.add("unstyled"), oe(t.theme), Se(t) ? Nt(i, t, r) : It(i, t, r);
}
function It(i, e, t) {
  const n = Mt(e.layout, {
    container: i,
...
const ie = ["Image", "BufferA", "BufferB", "BufferC", "BufferD"], $t = ["BufferA", "BufferB", "BufferC", "BufferD"], Pe = ["iChannel0", "iChannel1", "iChannel2", "iChannel3"], zt = "default", De = !0, Vt = "light", Me = /* @__PURE__ */ new Set([
  "iResolution",
  "iTime",
  "iTimeDelta",
  "iFrame",
  ...
  "iPinchDelta",
  "iPinchCenter"
]), Ht = /^[a-zA-Z_][a-zA-Z0-9_]*$/, jt = /* @__PURE__ */ new Set([
  "attribute",
  "const",
  "uniform",
  "varying",
...
function O(i) {
  return Ht.test(i) && !jt.has(i);
}
const ye = /* @__PURE__ */ new Set(["fullscreen", "default", "split", "tabbed"]), q = /* @__PURE__ */ new Set(["light", "dark", "system"]), Xt = /* @__PURE__ */ new Set([
  "mode",
  "title",
  "author",
  "description",
  ...
  "views"
  // multi-view projects
]), Kt = /* @__PURE__ */ new Set(["source", "iChannel0", "iChannel1", "iChannel2", "iChannel3"]), Te = /* @__PURE__ */ new Set(["keyboard", "audio", "webcam"]);
function Gt(i, e) {
  const t = [], n = [];
  ...
  if (i.layout !== void 0 && !ye.has(i.layout) && n.push(`Invalid layout '${i.layout}'. Expected one of: ${[...ye].join(", ")}`), i.theme !== void 0 && !q.has(i.theme) && n.push(`Invalid theme '${i.theme}'. Expected one of: ${[...q].join(", ")}`), i.uniforms && typeof i.uniforms == "object")
    for (const s of Object.keys(i.uniforms))
      Me.has(s) && n.push(`Uniform name '${s}' is reserved (built-in uniform)`), O(s) || n.push(`Uniform name '${s}' is not a valid GLSL identifier`);
  ...
  for (const s of ie) {
    ...
    if (!(!o || typeof o != "object")) {
      for (const a of Object.keys(o))
        Kt.has(a) || t.push(`Unknown key '${a}' in pass '${s}'`);
      for (const a of Pe) {
        const c = o[a];
...
function Yt(i, e) {
  ...
  if (i.layout !== void 0 && !xe.has(i.layout) && t.push(`Invalid multi-view layout '${i.layout}'. Expected one of: ${[...xe].join(", ")}`), i.theme !== void 0 && !q.has(i.theme) && t.push(`Invalid theme '${i.theme}'. Expected one of: ${[...q].join(", ")}`), i.uniforms && typeof i.uniforms == "object")
    for (const n of Object.keys(i.uniforms))
      Me.has(n) && t.push(`Uniform name '${n}' is reserved (built-in uniform)`), O(n) || t.push(`Uniform name '${n}' is not a valid GLSL identifier`);
  if (t.length > 0)
...
const we = /* @__PURE__ */ new Set(["float", "int", "bool", "vec2", "vec3", "vec4"]), _e = /* @__PURE__ */ new Set(["float", "vec2", "vec3", "vec4", "mat3", "mat4"]), Wt = {
  vec2: 2,
  vec3: 3,
  vec4: 4
};
...
async function Qt(i, e, t) {
  ...
  return n ? (Gt(n, e), n.mode === "shadertoy" ? en(i, e, n, t) : tn(i, e, n, t)) : Jt(i, e, t);
}
...
async function en(i, e, t, n) {
  ...
  const o = await Ue(i, e, t.common), a = new Be(), c = /* @__PURE__ */ new Map();
      ...
      if (d)
        for (const v of Pe) {
          ...
          if (b && "texture" in b && !c.has(b.texture)) {
            const y = await n.textureUrlResolver(b.texture), x = b.texture.split("/").pop(), _ = a.register(y, b.filter, b.wrap, x);
            c.set(b.texture, _);
          }
        }
    }
  ...
  for (const u of ie) {
    ...
    if (!d)
      continue;
    const v = d.source ?? Ot(u), T = i.joinPath(e, v);
    if (!await i.exists(T))
      throw new Error(`Source GLSL file for pass '${u}' not found at '${v}' in '${e}'.`);
    const b = await i.readText(T), y = [
    ...
    l[u] = { name: u, glslSource: b, channels: y };
  }
  if (!l.Image)
...
async function tn(i, e, t, n) {
  ...
  const r = await Ue(i, e, t.common), s = t.buffers ?? {};
...
const nn = /* @__PURE__ */ new Set(["keyboard", "audio", "webcam"]);
async function rn(i, e, t, n, r) {
  ...
  for (let b = 0; b < o.length; b++)
    a.set(o[b], $t[b]);
  const c = new Be(), l = /* @__PURE__ */ new Map();
  for (const [b, y] of a)
    l.set(b, { kind: "buffer", buffer: y, current: !1 });
  for (const [b, y] of Object.entries(t.textures ?? {}))
    if (y === "keyboard")
      ...
      let x;
      r != null && r.textureUrlResolver ? x = await r.textureUrlResolver(y) : x = y;
      const _ = c.register(x);
      l.set(b, { kind: "texture", name: _, cubemap: !1 });
    } else nn.has(y) || l.set(b, { kind: "script", name: y });
...
async function sn(i, e, t, n, r) {
  ...
  if (o in t && (a = await t[o]()), a && qe(a))
    return Yt(a, s), on(s, a, e, n, r);
  const c = await Ie(s, r), l = Ne(e, n), d = await Qt(l, s, {
    config: a,
    script: c,
...
async function on(i, e, t, n, r) {
  ...
  for (const d of e.views) {
    ...
    let b;
    if (U(t, v))
      b = await s.readText(v);
    else if (U(t, T))
      b = await s.readText(T);
    else
...
const an = /* @__PURE__ */ Object.assign({ "./shaders/parameter-space-zoom/common.glsl": () => Promise.resolve().then(() => vn).then((i) => i.default), "./shaders/parameter-space-zoom/invertedStrip.glsl": () => Promise.resolve().then(() => bn).then((i) => i.default), "./shaders/parameter-space-zoom/resulting_pack.glsl": () => Promise.resolve().then(() => Tn).then((i) => i.default), "./shaders/parameter-space-zoom/stripPack.glsl": () => Promise.resolve().then(() => wn).then((i) => i.default) }), cn = /* @__PURE__ */ Object.assign({ "./shaders/parameter-space-zoom/config.json": () => Promise.resolve().then(() => Cn).then((i) => i.default) }), ln = /* @__PURE__ */ Object.assign({}), un = /* @__PURE__ */ Object.assign({ "./shaders/parameter-space-zoom/script.js": () => Promise.resolve().then(() => Fn) });
let ne = null;
async function dn() {
  return ne || (ne = await sn("shaders/parameter-space-zoom", an, cn, ln, un)), ne;
}
async function Ln(i, e = {}) {
  const t = await dn();
  return Bt(i, { project: t, ...e });
}
class hn {
  constructor(e, t) {
...
(function(i) {
  ...
  var t = function(n) {
    var r = /(?:^|\s)lang(?:uage)?-([\w-]+)(?=\s|$)/i, s = 0, o = {}, a = {
        ...
        insertBefore: function(m, h, f, p) {
          ...
          for (var R in g)
            if (g.hasOwnProperty(R)) {
              if (R == h)
                for (var E in f)
                  f.hasOwnProperty(E) && (w[E] = f[E]);
              f.hasOwnProperty(R) || (w[R] = g[R]);
            }
          var C = p[m];
          return p[m] = w, a.languages.DFS(a.languages, function(A, S) {
            S === C && A != m && (this[A] = w);
          }), w;
        },
        ...
        DFS: function m(h, f, p, g) {
          ...
          for (var R in h)
            if (h.hasOwnProperty(R)) {
              ...
              C === "Object" && !g[w(E)] ? (g[w(E)] = !0, m(E, f, null, g)) : C === "Array" && !g[w(E)] && (g[w(E)] = !0, m(E, f, R, g));
            }
        }
      },
      plugins: {},
      ...
      tokenize: function(m, h) {
        ...
        var g = new d();
        return v(g, g.head, m), u(m, g, h, g.head, 0), b(g);
      },
      /**
       * @namespace
       * @memberof Prism
      ...
      for (var R in f)
        if (!(!f.hasOwnProperty(R) || !f[R])) {
          ...
          for (var C = 0; C < E.length; ++C) {
            if (w && w.cause == R + "," + C)
              return;
            var A = E[C], S = A.inside, B = !!A.lookbehind, ce = !!A.greedy, Ke = A.alias;
            if (ce && !A.pattern.global) {
              var Ge = A.pattern.toString().match(/[imsuy]*$/)[0];
              A.pattern = RegExp(A.pattern.source, Ge + "g");
            }
            for (var le = A.pattern || A, F = p.next, P = g; F !== h.tail && !(w && P >= w.reach); P += F.value.length, F = F.next) {
              var I = F.value;
              ...
              if (!(I instanceof c)) {
                ...
                if (ce) {
                  if (L = l(le, P, m, B), !L || L.index >= m.length)
                    break;
                  var j = L.index, Ye = L.index + L[0].length, M = P;
                  for (M += F.value.length; j >= M; )
                    F = F.next, M += F.value.length;
                  if (M -= F.value.length, P = M, F.value instanceof c)
                    continue;
                  for (var N = F; N !== h.tail && (M < Ye || typeof N.value == "string"); N = N.next)
                    H++, M += N.value.length;
                  H--, I = m.slice(P, M), L.index -= P;
                } else if (L = l(le, 0, I, B), !L)
                  continue;
                var j = L.index, X = L[0], Q = I.slice(0, j), ue = I.slice(j + X.length), J = P + I.length;
                w && J > w.reach && (w.reach = J);
                var K = F.prev;
                Q && (K = v(h, K, Q), P += Q.length), T(h, K, H);
                var We = new c(R, S ? a.tokenize(X, S) : X, Ke, X);
                if (F = v(h, K, We), ue && v(h, F, ue), H > 1) {
                  var ee = {
                    cause: R + "," + C,
                    reach: J
                  };
                  u(m, h, f, F.prev, P, ee), w && ee.reach > w.reach && (w.reach = ee.reach);
                }
              }
            }
          }
  ...
  i.exports && (i.exports = t), typeof Ce < "u" && (Ce.Prism = t), t.languages.markup = {
    ...
    t.hooks.add("before-highlightall", function(y) {
      ...
      if (x.matches(d)) {
        y.code = "", x.setAttribute(a, c);
        var _ = x.appendChild(document.createElement("CODE"));
        _.textContent = n;
        var m = x.getAttribute("data-src"), h = y.language;
        if (h === "none") {
        ...
        p && p.loadLanguages(h), v(
          ...
          function(g) {
            x.setAttribute(a, l);
            var w = T(x.getAttribute("data-range"));
            if (w) {
...
function fn(i, e, t) {
  ...
  function l() {
    const v = o.value;
    c.textContent = v + `
`, pn.highlightElement(c);
    const T = v.split(`
`);
    r.innerHTML = T.map((b, y) => `<span>${y + 1}</span>`).join(""), t && t(v);
  }
  function u() {
  ...
  function d(v) {
    if (v.key === "Tab") {
      v.preventDefault();
      const T = o.selectionStart, b = o.selectionEnd, y = o.value;
      o.value = y.substring(0, T) + "  " + y.substring(b), o.selectionStart = o.selectionEnd = T + 2, l();
    }
  }
...
const ze = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  createEditor: fn
}, Symbol.toStringTag, { value: "Module" })), gn = `float EPS=1e-4;
...
`, Tn = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: yn
}, Symbol.toStringTag, { value: "Module" })), xn = `// --- 4. RENDER LOGIC ---
...
`, wn = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: xn
}, Symbol.toStringTag, { value: "Module" })), Ve = "ACP parameter space zoom", He = [
  "stripPack",
  "resulting_pack",
  "invertedStrip"
], je = "split", Xe = {
  ...
  u_zoom_resulting_pack: {
    type: "float",
    value: 1,
    hidden: !0
  },
  u_pan_resulting_pack: {
    type: "vec2",
    value: [
      0,
      0
  ...
  resulting_pack: { zoom: 1, panX: 0, panY: 0, zoomKey: "u_zoom_resulting_pack", panKey: "u_pan_resulting_pack" },
  invertedStrip: { zoom: 1, panX: 0, panY: 0, zoomKey: "u_zoom_invertedStrip", panKey: "u_pan_invertedStrip" }
};
...
function Sn(i, e, t) {
  ...
  for (const [l, u, d, v, T] of c) {
    ...
    if (b.textContent = d, b.style.cssText = `grid-column: ${v}; grid-row: ${T};` + a, d === "↺")
      b.addEventListener("mousedown", (x) => {
        x.stopPropagation(), e.zoom = 1, e.panX = 0, e.panY = 0, t.setUniformValue(e.zoomKey, e.zoom), t.setUniformValue(e.panKey, [e.panX, e.panY]);
      });
    else {
      let x = null;
      b.addEventListener("mousedown", (_) => {
        _.stopPropagation(), Re(i, e, t, l, u), x = setInterval(() => Re(i, e, t, l, u), 80);
...
function An(i, e, t) {
  ...
  n && (Sn(n, t, i), n.addEventListener("wheel", (r) => {
