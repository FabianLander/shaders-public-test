...
class ge {
  ...
  resize(e, t) {
    ...
    for (const r of this._passes)
      n.deleteTexture(r.currentTexture), n.deleteTexture(r.previousTexture), n.deleteFramebuffer(r.framebuffer), r.currentTexture = Y(n, e, t), r.previousTexture = Y(n, e, t), r.framebuffer = me(n, r.currentTexture);
  }
  /**
  ...
  updateKeyboardTexture() {
    this._keyboardTexture && Qe(this.gl, this._keyboardTexture.texture, this._keyStates, this._toggleStates);
  }
  /**
  ...
  initRuntimePasses() {
    ...
    for (const s of r) {
      ...
      try {
        const l = he(e, fe, a), u = this.cacheUniformLocations(l, o.namedSamplers), d = Y(e, this._width, this._height), v = Y(e, this._width, this._height), y = me(e, d), T = {
          name: s,
...
`) : "";
    this.overlay.innerHTML = `
      <div class="script-error-content">
        ...
        <pre class="script-error-message">${K(n)}</pre>
        ${r ? `<pre class="script-error-stack">${K(r)}</pre>` : ""}
      </div>
  ...
  showWarning(e, t) {
    this.clearAutoHide(), this.ensureOverlay(), this.overlay.innerHTML = `
      <div class="script-error-content">
        ...
        <pre class="script-error-message">${K(t)}</pre>
      </div>
    `, this.wireClose(), this.autoHideTimer = setTimeout(() => this.hide(), z.AUTO_HIDE_MS);
  }
  /**
...
function yt(i, e) {
  ...
  const u = !!((p = i.script) != null && p.setup || (g = i.script) != null && g.onFrame), d = Object.entries(i.uniforms).filter(([, E]) => !A(E)), v = [];
  for (const [E, C] of d) {
    if (A(C))
      continue;
    const F = r[E] ?? C.value;
...
async function Mt(i, e) {
  ...
  return n || i.classList.add("unstyled"), oe(t.theme), Re(t) ? Bt(i, t, r) : Ut(i, t, r);
}
function Ut(i, e, t) {
  const n = Pt(e.layout, {
    container: i,
...
const we = /* @__PURE__ */ new Set(["float", "int", "bool", "vec2", "vec3", "vec4"]), _e = /* @__PURE__ */ new Set(["float", "vec2", "vec3", "vec4", "mat3", "mat4"]), Yt = {
  vec2: 2,
  vec3: 3,
  vec4: 4
};
...
async function qt(i, e, t) {
  ...
  return n ? (Xt(n, e), n.mode === "shadertoy" ? Qt(i, e, n, t) : Jt(i, e, n, t)) : Zt(i, e, t);
}
...
async function nn(i, e, t, n, r) {
  ...
  if (o in t && (a = await t[o]()), a && Ke(a))
    return Gt(a, s), rn(s, a, e, n, r);
  const c = await Be(s, r), l = Ie(e, n), d = await qt(l, s, {
    config: a,
    script: c,
...
const sn = /* @__PURE__ */ Object.assign({ "./shaders/parameter-space-split-color/common.glsl": () => Promise.resolve().then(() => fn).then((i) => i.default), "./shaders/parameter-space-split-color/invertedStrip.glsl": () => Promise.resolve().then(() => vn).then((i) => i.default), "./shaders/parameter-space-split-color/resulting_pack.glsl": () => Promise.resolve().then(() => bn).then((i) => i.default), "./shaders/parameter-space-split-color/stripPack.glsl": () => Promise.resolve().then(() => yn).then((i) => i.default) }), on = /* @__PURE__ */ Object.assign({ "./shaders/parameter-space-split-color/config.json": () => Promise.resolve().then(() => wn).then((i) => i.default) }), an = /* @__PURE__ */ Object.assign({}), cn = /* @__PURE__ */ Object.assign({ "./shaders/parameter-space-split-color/script.js": () => Promise.resolve().then(() => _n) });
let ne = null;
async function ln() {
  return ne || (ne = await nn("shaders/parameter-space-split-color", sn, on, an, cn)), ne;
}
      ...
      for (var R in f)
        if (!(!f.hasOwnProperty(R) || !f[R])) {
          ...
          for (var C = 0; C < E.length; ++C) {
            if (w && w.cause == R + "," + C)
              return;
            var F = E[C], S = F.inside, B = !!F.lookbehind, ce = !!F.greedy, je = F.alias;
            if (ce && !F.pattern.global) {
              var Xe = F.pattern.toString().match(/[imsuy]*$/)[0];
              F.pattern = RegExp(F.pattern.source, Xe + "g");
            }
            for (var le = F.pattern || F, k = p.next, P = g; k !== h.tail && !(w && P >= w.reach); P += k.value.length, k = k.next) {
              var I = k.value;
              ...
              if (!(I instanceof c)) {
                ...
                if (ce) {
                  if (L = l(le, P, m, B), !L || L.index >= m.length)
                    break;
                  var j = L.index, Ge = L.index + L[0].length, M = P;
                  for (M += k.value.length; j >= M; )
                    k = k.next, M += k.value.length;
                  if (M -= k.value.length, P = M, k.value instanceof c)
                    continue;
                  for (var N = k; N !== h.tail && (M < Ge || typeof N.value == "string"); N = N.next)
                    H++, M += N.value.length;
                ...
                var G = k.prev;
                Q && (G = v(h, G, Q), P += Q.length), y(h, G, H);
                var Ye = new c(R, S ? a.tokenize(X, S) : X, je, X);
...
const $e = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  createEditor: mn
}, Symbol.toStringTag, { value: "Module" })), pn = `float EPS=1e-4;
...
`, fn = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: pn
}, Symbol.toStringTag, { value: "Module" })), gn = `// --- 4. RENDER LOGIC ---
...
`, vn = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: gn
}, Symbol.toStringTag, { value: "Module" })), En = `// --- 4. RENDER LOGIC ---
...
`, bn = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: En
}, Symbol.toStringTag, { value: "Module" })), Tn = `// --- 4. RENDER LOGIC ---
