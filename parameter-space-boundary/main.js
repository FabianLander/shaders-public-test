...
function me(i, e) {
  ...
  if (n !== i.FRAMEBUFFER_COMPLETE)
    throw i.deleteFramebuffer(t), new Error(`Framebuffer incomplete: ${rt(i, n)}`);
...
`, lt = `// --- Keyboard helpers (auto-injected) ---
// Letter keys
...
`), t.viewNames && t.viewNames.length > 1) {
    ...
    n.push(""), t.namedSamplers.has("keyboard") && (n.push(lt), n.push(""));
...
`), t.viewNames && t.viewNames.length > 1) {
  ...
  const r = Object.entries(t.uniforms).filter(([, d]) => !F(d));
  if (r.length > 0) {
...
class ht {
  ...
  updateAudioTexture(e) {
    var t;
    (t = this._audioTexture) != null && t.analyser && (this._audioTexture.analyser.getByteFrequencyData(this._audioTexture.frequencyData), this._audioTexture.analyser.getByteTimeDomainData(this._audioTexture.waveformData), tt(e, this._audioTexture.texture, this._audioTexture.frequencyData, this._audioTexture.waveformData));
  }
  updateVideoTextures(e) {
    for (const t of this._videoTextures)
      !t.ready || !t.video || t.video.readyState < HTMLMediaElement.HAVE_CURRENT_DATA || (nt(e, t.texture, t.video), t.video.videoWidth > 0 && (t.width = t.video.videoWidth, t.height = t.video.videoHeight));
  }
  // ===========================================================================
  // Cleanup
  // ===========================================================================
...
class mt {
  ...
  initializeDefaults() {
    for (const [e, t] of Object.entries(this.definitions))
      F(t) ? this.values[e] = new Float32Array($(t.type, t.count)) : this.values[e] = this.cloneValue(t.value);
  }
  /**
  ...
  reset(e) {
    ...
    return t ? (F(t) ? this.values[e] = new Float32Array($(t.type, t.count)) : this.values[e] = this.cloneValue(t.value), !0) : !1;
  }
  /**
  ...
  getDefault(e) {
    const t = this.definitions[e];
    if (t)
      return F(t) ? new Float32Array($(t.type, t.count)) : this.cloneValue(t.value);
  }
  /**
...
class pt {
  constructor(e, t) {
    this._ubos = [], this._dirtyScalars = /* @__PURE__ */ new Set(), this._uniforms = t, this._store = new mt(t), this.initUBOs(e);
    for (const [n, r] of Object.entries(t))
      F(r) || this._dirtyScalars.add(n);
  }
  // ===========================================================================
  // Accessors
  // ===========================================================================
  ...
  set(e, t) {
    ...
    if (this._store.set(e, t), F(n)) {
      ...
      if (r) {
        ...
        const c = s.length / a, l = at(n.type, c, s, r.paddedData);
        l !== r.paddedData && r.paddedData.set(l);
        const u = ot(n.type, c), d = r.paddedData.length;
...
class ge {
  constructor(e) {
    ...
    this._keyboardTexture = {
      ...
      width: 256,
      height: 3
    }, this.initProjectTextures(), this._media = new ht(this.gl, e.project), this._uniformMgr = new pt(this.gl, e.project.uniforms), e.viewNames && e.viewNames.length > 1 && (this._viewNames = e.viewNames), this.initRuntimePasses();
  }
  // ===========================================================================
  ...
  updateTexture(e, t, n, r) {
    ...
    if (s && s.width === t && s.height === n && s.isFloat === o) {
      ...
      const a = it(this.gl, (s == null ? void 0 : s.texture) ?? null, t, n, r);
  ...
  updateKeyboardTexture() {
    this._keyboardTexture && Je(this.gl, this._keyboardTexture.texture, this._keyStates, this._toggleStates);
  }
  /**
  ...
  cacheUniformLocations(e, t) {
    ...
    for (const [s, o] of Object.entries(this.project.uniforms))
      F(o) || r.set(s, n.getUniformLocation(e, s));
   ...
   */
  initRuntimePasses() {
    const e = this.gl, t = this.project, n = qe(e);
    this._sharedVAO = n;
    ...
    for (const s of r) {
      ...
      try {
        const l = he(e, fe, a), u = this.cacheUniformLocations(l, o.namedSamplers), d = K(e, this._width, this._height), v = K(e, this._width, this._height), y = me(e, d), T = {
          name: s,
...
`).map((n) => {
    ...
    if (r) {
      ...
      let c = a;
      return t && e.commonStartLine > 0 ? c = a - e.commonStartLine + 1 : e.userCodeStartLine > 0 && a >= e.userCodeStartLine && (c = a - e.userCodeStartLine + 1), `Line ${c}: ${vt(o)}`;
    }
    return n;
  }).join(`
`);
...
`);
  ...
  return t.slice(r, s).map((a, c) => {
    const l = r + c + 1, u = l === e, d = String(l).padStart(4, " "), v = Ae(a);
...
class Ee {
  ...
  constructor(e) {
    ...
    }), this._resizeObserver.observe(this.container), this.input = new bt(this.canvas, this._pixelRatio), this.input.onFirstGesture = () => this.initMediaOnGesture(), this.initVideoFiles();
  }
  // ===========================================================================
  // Per-Frame Rendering
  // ===========================================================================
...
class Fe {
  constructor(e) {
    ...
    for (const [n, r] of Object.entries(this.uniforms))
      F(r) || r.hidden || (this.values[n] = ((t = e.initialValues) == null ? void 0 : t[n]) ?? r.value);
    this.render();
  }
  /**
  ...
  createVecSliders(e, t, n) {
    ...
    return o.forEach((u, d) => {
      ...
      w && w.classList.add("uniform-control-vec-slider"), l.push(T), a.appendChild(y);
    }), {
      element: a,
      update: (u) => {
        const d = u;
  ...
  resetToDefaults() {
    for (const [e, t] of Object.entries(this.uniforms))
      F(t) || t.hidden || (this.setValue(e, t.value), this.onChange(e, t.value));
  }
  /**
...
function wt(i, e) {
  ...
  const u = !!((p = i.script) != null && p.setup || (g = i.script) != null && g.onFrame), d = Object.entries(i.uniforms).filter(([, E]) => !F(E)), v = [];
  for (const [E, C] of d) {
    if (F(C))
      continue;
    const A = r[E] ?? C.value;
...
class D {
  constructor(e) {
    ...
    if (this.recorder = new xt(this.primaryView.canvas, this.container, this.project.root), this.statsPanel = new _t(this.container), this.statsPanel.updateResolution(this.primaryView.canvas.width, this.primaryView.canvas.height), this.isMultiView) {
    ...
    if (this.project.controls && !e.skipPlaybackControls && (this.playbackControls = new Ct(this.container, {
  ...
  exportHTML() {
    ...
    yt(this.project, this.primaryView.engine);
  }
  openRenderDialog() {
    new Rt(this.container, this.primaryView.canvas.width, this.primaryView.canvas.height, (t) => this.renderOffline(t)).open();
  }
  renderOffline(e) {
    let t = !1;
    const n = () => {
...
class kt {
  ...
  async buildEditorPanel() {
    try {
      const { EditorPanel: e } = await Promise.resolve().then(() => hn);
      if (this._disposed)
        return;
...
async function Mt(i, e) {
  ...
  return n || i.classList.add("unstyled"), oe(t.theme), Re(t) ? It(i, t, r) : Ut(i, t, r);
}
function Ut(i, e, t) {
  const n = Dt(e.layout, {
    container: i,
...
function It(i, e, t) {
  const n = e.views.map((a) => a.name), r = Bt(e.viewLayout, {
    container: i,
    project: e,
    viewNames: n
  }), s = new D({
...
const ie = ["Image", "BufferA", "BufferB", "BufferC", "BufferD"], Ot = ["BufferA", "BufferB", "BufferC", "BufferD"], Le = ["iChannel0", "iChannel1", "iChannel2", "iChannel3"], $t = "default", Pe = !0, zt = "light", De = /* @__PURE__ */ new Set([
  "iResolution",
  "iTime",
  "iTimeDelta",
  "iFrame",
  ...
  "iPinchDelta",
  "iPinchCenter"
]), Vt = /^[a-zA-Z_][a-zA-Z0-9_]*$/, Ht = /* @__PURE__ */ new Set([
  "attribute",
  "const",
  "uniform",
  "varying",
...
function O(i) {
  return Vt.test(i) && !Ht.has(i);
}
const Te = /* @__PURE__ */ new Set(["fullscreen", "default", "split", "tabbed"]), q = /* @__PURE__ */ new Set(["light", "dark", "system"]), jt = /* @__PURE__ */ new Set([
  "mode",
  "title",
  "author",
  "description",
  ...
  "views"
  // multi-view projects
]), Xt = /* @__PURE__ */ new Set(["source", "iChannel0", "iChannel1", "iChannel2", "iChannel3"]), ye = /* @__PURE__ */ new Set(["keyboard", "audio", "webcam"]);
function Gt(i, e) {
  const t = [], n = [];
  for (const s of Object.keys(i))
    jt.has(s) || t.push(`Unknown config key '${s}'`);
  ...
  for (const s of ie) {
    ...
    if (!(!o || typeof o != "object")) {
      for (const a of Object.keys(o))
        Xt.has(a) || t.push(`Unknown key '${a}' in pass '${s}'`);
      for (const a of Le) {
        const c = o[a];
...
function W(i, e, t, n, r, s) {
  if (!i)
    return { kind: "none" };
  const o = ke(i);
  return o ? qt(o, e, t, n, r, s) : { kind: "none" };
}
async function Qt(i, e, t) {
  ...
  return n ? (Gt(n, e), n.mode === "shadertoy" ? Jt(i, e, n, t) : en(i, e, n, t)) : Zt(i, e, t);
}
...
async function Jt(i, e, t, n) {
  ...
  const o = await Be(i, e, t.common), a = new Me(), c = /* @__PURE__ */ new Map();
      ...
      if (d)
        for (const v of Le) {
          ...
          if (T && "texture" in T && !c.has(T.texture)) {
            const b = await n.textureUrlResolver(T.texture), w = T.texture.split("/").pop(), _ = a.register(b, T.filter, T.wrap, w);
            c.set(T.texture, _);
          }
        }
    }
  ...
  for (const u of ie) {
    ...
    if (!d)
      continue;
    const v = d.source ?? Nt(u), y = i.joinPath(e, v);
    if (!await i.exists(y))
...
async function en(i, e, t, n) {
  ...
  const r = await Be(i, e, t.common), s = t.buffers ?? {};
...
async function nn(i, e, t, n, r) {
  ...
  for (let T = 0; T < o.length; T++)
    a.set(o[T], Ot[T]);
  const c = new Me(), l = /* @__PURE__ */ new Map();
  for (const [T, b] of a)
  ...
  for (const [T, b] of Object.entries(t.textures ?? {}))
    ...
    } else tn.has(b) || l.set(T, { kind: "script", name: b });
...
async function rn(i, e, t, n, r) {
  ...
  if (o in t && (a = await t[o]()), a && We(a))
    return Kt(a, s), sn(s, a, e, n, r);
  const c = await Ue(s, r), l = Ie(e, n), d = await Qt(l, s, {
    config: a,
    script: c,
...
const on = /* @__PURE__ */ Object.assign({ "./shaders/parameter-space-boundary/common.glsl": () => Promise.resolve().then(() => gn).then((i) => i.default), "./shaders/parameter-space-boundary/invertedStrip.glsl": () => Promise.resolve().then(() => En).then((i) => i.default), "./shaders/parameter-space-boundary/resulting_pack.glsl": () => Promise.resolve().then(() => Tn).then((i) => i.default), "./shaders/parameter-space-boundary/stripPack.glsl": () => Promise.resolve().then(() => wn).then((i) => i.default) }), an = /* @__PURE__ */ Object.assign({ "./shaders/parameter-space-boundary/config.json": () => Promise.resolve().then(() => _n).then((i) => i.default) }), cn = /* @__PURE__ */ Object.assign({}), ln = /* @__PURE__ */ Object.assign({ "./shaders/parameter-space-boundary/script.js": () => Promise.resolve().then(() => Cn) });
let ne = null;
async function un() {
  return ne || (ne = await rn("shaders/parameter-space-boundary", on, an, cn, ln)), ne;
}
async function Rn(i, e = {}) {
  const t = await un();
  return Mt(i, { project: t, ...e });
}
class dn {
  constructor(e, t) {
    ...
    var r = /(?:^|\s)lang(?:uage)?-([\w-]+)(?=\s|$)/i, s = 0, o = {}, a = {
      ...
      languages: {
        ...
        insertBefore: function(m, h, f, p) {
          ...
          var C = p[m];
          return p[m] = x, a.languages.DFS(a.languages, function(A, S) {
            S === C && A != m && (this[A] = x);
          }), x;
        },
      ...
      for (var R in f)
        if (!(!f.hasOwnProperty(R) || !f[R])) {
          ...
          for (var C = 0; C < E.length; ++C) {
            if (x && x.cause == R + "," + C)
              return;
            var A = E[C], S = A.inside, U = !!A.lookbehind, ce = !!A.greedy, Xe = A.alias;
            if (ce && !A.pattern.global) {
              var Ge = A.pattern.toString().match(/[imsuy]*$/)[0];
              A.pattern = RegExp(A.pattern.source, Ge + "g");
            }
            for (var le = A.pattern || A, k = p.next, P = g; k !== h.tail && !(x && P >= x.reach); P += k.value.length, k = k.next) {
              var I = k.value;
              ...
              if (!(I instanceof c)) {
                var H = 1, L;
                if (ce) {
                  if (L = l(le, P, m, U), !L || L.index >= m.length)
                    break;
                  var j = L.index, Ke = L.index + L[0].length, B = P;
                  for (B += k.value.length; j >= B; )
                    k = k.next, B += k.value.length;
                  if (B -= k.value.length, P = B, k.value instanceof c)
                    continue;
                  for (var N = k; N !== h.tail && (B < Ke || typeof N.value == "string"); N = N.next)
                    H++, B += N.value.length;
                  H--, I = m.slice(P, B), L.index -= P;
                } else if (L = l(le, 0, I, U), !L)
                  continue;
                var j = L.index, X = L[0], Z = I.slice(0, j), ue = I.slice(j + X.length), J = P + I.length;
                x && J > x.reach && (x.reach = J);
                var G = k.prev;
                Z && (G = v(h, G, Z), P += Z.length), y(h, G, H);
                var Ye = new c(R, S ? a.tokenize(X, S) : X, Xe, X);
                if (k = v(h, G, Ye), ue && v(h, k, ue), H > 1) {
                  var ee = {
                    cause: R + "," + C,
                    reach: J
                  };
                  u(m, h, f, k.prev, P, ee), x && ee.reach > x.reach && (x.reach = ee.reach);
                }
              }
            }
          }
...
const $e = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  createEditor: pn
}, Symbol.toStringTag, { value: "Module" })), fn = `float EPS=1e-4;
...
`, gn = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: fn
}, Symbol.toStringTag, { value: "Module" })), vn = `// --- 4. RENDER LOGIC ---
...
`, wn = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: yn
}, Symbol.toStringTag, { value: "Module" })), ze = "ACP parameter space", Ve = "Visualize the parameter space of Descartes Quadruples, showing the boundaries of the quadruple and the equivalence of maps.", He = [
  "stripPack",
  "resulting_pack",
  "invertedStrip"
], je = "split", xn = {
